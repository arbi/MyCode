...
class Document extends FormBase
{
    ...
    public function __construct($data, $options)
    {
        ...
        if (is_object($data)) {
            ...
            $objectData['valid_from']         = ($data->getValidFrom() === NULL) ? '' : $data->getValidFromJQueqryDatePickerFormat();
            $objectData['valid_to']           = ($data->getValidTo() === NULL)   ? '' : $data->getValidToJQueqryDatePickerFormat();
